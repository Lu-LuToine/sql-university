...
(1, 'marc.math_prof@ecole.com', 'Luis', 'Marc', '2016-12-01', 'Mathématiques'),
(2, 'martin.prof_francais@ecole.com', 'Sophie', 'Martin', '2017-09-15', 'Français'),
(3, 'leroy.prof_physique@ecole.com', 'Thomas', 'Leroy', '2018-04-10', 'Physique'), 
(4, 'dupont.prof_histoire@ecole.com', 'Laura', 'Dupont', '2019-11-22', 'Histoire'), 
(5, 'garcia.prof_chimie@ecole.com', 'Antoine', 'Garcia', '2020-06-05', 'Chimie'), 
(6, 'bertrand.prof_anglais@ecole.com', 'Amélie', 'Bertrand', '2021-01-30', 'Anglais'), 
(7, 'petit.prof_informatique@ecole.com', 'Pierre', 'Petit', '2022-08-18', 'Informatique'); 
...
(8, 8, 1, '2023-01-15', 4),
(9, 9, 1, '2023-01-15', 12),
(10, 10, 1, '2023-01-15', 9),
(11, 11, 1, '2023-01-15', 3),
(12, 12, 1, '2023-01-15', 16),
(13, 13, 1, '2023-01-15', 7),
(14, 14, 1, '2023-01-15', 14),
(15, 15, 1, '2023-01-15', 20);

INSERT INTO PROMO(PROMO, NOTE_ID, STUDENT_ID) VALUES
(2023, 1, 1);

INSERT INTO AD_ABSENCES(ABSENCE_ID, STUDENT_ID, DUREE, ABS_DATE, JUSTIFICATION) VALUES 
(2, 5, 90, '2023-01-16', 0),
(3, 6, 60, '2023-01-17', 0),
(4, 7, 150, '2023-01-18', 1),
(5, 8, 120, '2023-01-19', 1);
